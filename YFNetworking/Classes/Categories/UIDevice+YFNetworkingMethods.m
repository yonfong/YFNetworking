//
//  UIDevice+YFNetworkingMethods.m
//  Pods
//
...
@implementation UIDevice (YFNetworkingMethods)
...
- (NSString *) yf_macaddressMD5{
    ...
    if (macid.length == 0) {
        NSString *macaddress = [[UIDevice currentDevice] yf_macaddress];
        macid = [macaddress yf_md5];
        if (!macid){
