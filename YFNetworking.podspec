...
Pod::Spec.new do |s|
  s.name             = 'YFNetworking'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YFNetworking.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/bluesky0109/YFNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'bluesky0109' => 'yonfeng.zhang@gmail.com' }
  s.source           = { :git => 'https://github.com/bluesky0109/YFNetworking.git', :tag => s.version.to_s }
