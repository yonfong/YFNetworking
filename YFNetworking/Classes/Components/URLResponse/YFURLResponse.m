...
@interface YFURLResponse ()

@property (nonatomic, assign, readwrite) YFURLResponseStatus status;
...
- (YFURLResponseStatus)responseStatusWithError:(NSError *)error {
    if (error) {
        ...
        if (error.code == NSURLErrorTimedOut) {
            result = YFURLResponseStatusErrorTimeout;
        }
        return result;
    } else {
        return YFURLResponseStatusSuccess;
    }
}
